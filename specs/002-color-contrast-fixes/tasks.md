...
**Checkpoint**: User Stories 1 AND 2 are both implemented and locally sanity-checked; DEV verification of all 4 originally-flagged URLs is deferred until post-merge (see T009-T011, T016).

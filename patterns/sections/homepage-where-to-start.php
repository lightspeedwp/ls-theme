...
<section class="wp-block-group alignfull is-style-content-band">
	...
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading has-700-font-size" style="margin-top:var(--wp--preset--spacing--20);font-weight:var(--wp--custom--typography--font-weight--extrabold)"><?php echo esc_html__( 'Three honest routes into LightSpeed.', 'ls-theme' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"style":{"color":{"text":"var(--wp--custom--color--text--muted)"},"spacing":{"margin":{"top":"var:preset|spacing|10"}}},"fontSize":"300"} -->
		<p class="has-text-color has-300-font-size" style="color:var(--wp--custom--color--text--muted);margin-top:var(--wp--preset--spacing--10)"><?php echo esc_html__( 'The home page is here to point you at the right next step. Pick the journey that matches where you are right now.', 'ls-theme' ); ?></p>
		<!-- /wp:paragraph -->

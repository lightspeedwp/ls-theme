...
<section class="wp-block-group alignfull is-style-content-band" style="padding-top:var(--wp--preset--spacing--100);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--60)">
	...
	<!-- wp:group {"align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"layout":{"type":"flow"}} -->
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-columns are-vertically-aligned-top" style="margin-top:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-column is-vertically-aligned-top">
				<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"},"color":{"text":"var(--wp--custom--color--text--muted)"}},"fontSize":"200"} -->
				<p class="has-text-color has-200-font-size" style="color:var(--wp--custom--color--text--muted);line-height:1.5"><?php echo esc_html__( 'AI readiness starts with understanding what already exists. In Discover, we assess your content, systems, workflows and internal constraints to see where AI can add value and where it may introduce risk, confusion or unnecessary cost.', 'ls-theme' ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"},"spacing":{"margin":{"top":"var:preset|spacing|10"}},"color":{"text":"var(--wp--custom--color--text--muted)"}},"fontSize":"200"} -->
				<p class="has-text-color has-200-font-size" style="color:var(--wp--custom--color--text--muted);margin-top:var(--wp--preset--spacing--10);line-height:1.5"><?php echo esc_html__( 'This is where we identify the practical foundations needed for the later stages: content quality, metadata consistency, migration risk, reporting needs, governance considerations and realistic opportunities for automation or AI-supported visibility.', 'ls-theme' ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"},"spacing":{"margin":{"top":"var:preset|spacing|10"}},"color":{"text":"var(--wp--custom--color--text--muted)"}},"fontSize":"200"} -->
				<p class="has-text-color has-200-font-size" style="color:var(--wp--custom--color--text--muted);margin-top:var(--wp--preset--spacing--10);line-height:1.5"><?php echo esc_html__( 'The goal is not to force AI into the project. It is to produce a clear view of readiness, risk and opportunity before design or development begins.', 'ls-theme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column is-vertically-aligned-top">
				...
				<div class="wp-block-group has-border-color" style="border-color:var(--wp--custom--color--border--card);border-style:solid;border-width:1px;border-radius:var(--wp--preset--border-radius--300);padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
					<!-- wp:paragraph {"style":{"typography":{"fontWeight":"var:custom|typography|font-weight|bold"},"color":{"text":"<?php echo esc_attr( $ls_phase_accent ); ?>"}},"fontSize":"200"} -->
					...
					<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--20)">
						...
						<div class="wp-block-group">
							<!-- wp:group {"style":{"border":{"color":"<?php echo esc_attr( $ls_phase_accent ); ?>","radius":"var:preset|border-radius|500","style":"solid","width":"1px"},"spacing":{"padding":{"top":"var:preset|spacing|5","right":"var:preset|spacing|5","bottom":"var:preset|spacing|5","left":"var:preset|spacing|5"}}},"layout":{"type":"flex","justifyContent":"center","verticalAlignment":"center"}} -->
							<div class="wp-block-group has-border-color" style="border-color:<?php echo esc_attr( $ls_phase_accent ); ?>;border-style:solid;border-width:1px;border-radius:var(--wp--preset--border-radius--500);padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)"></div>
							<!-- /wp:group -->

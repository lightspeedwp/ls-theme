		...
		<div class="wp-block-columns alignwide are-vertically-aligned-center" style="--wp--style--block-gap:var(--wp--preset--spacing--60)">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:58%">
				...
				<div class="wp-block-group">
					...
					<p class="has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--brand);font-weight:var(--wp--custom--typography--font-weight--semibold);letter-spacing:var(--wp--custom--typography--letter-spacing--widest);text-transform:uppercase"><?php echo esc_html__( 'Ready to discuss a project?', 'ls-theme' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->

...
<div class="wp-block-group is-style-glass-card ls-cta-strip">
	...
	<div class="wp-block-group ls-cta-strip__intro">
		...
		<div class="wp-block-group ls-cta-strip__icon" style="background-color:color-mix(in srgb, var(--wp--custom--color--text--brand) 20%, transparent);border-radius:var(--wp--preset--border-radius--300);padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">
			<!-- wp:html -->
		...
		<div class="wp-block-group ls-cta-strip__text">
			<!-- wp:heading {"level":3,"style":{"color":{"text":"var(--wp--custom--color--text--default)"},"typography":{"fontWeight":"var:custom|typography|font-weight|extrabold"}},"fontSize":"small"} -->
			<h3 class="wp-block-heading has-small-font-size" style="color:var(--wp--custom--color--text--default);font-weight:var(--wp--custom--typography--font-weight--extrabold)"><?php echo esc_html__( 'Prefer to talk it through first?', 'ls-theme' ); ?></h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"color":{"text":"var(--wp--custom--color--text--muted)"}},"fontSize":"x-small"} -->
			<p class="has-x-small-font-size" style="color:var(--wp--custom--color--text--muted)"><?php echo esc_html__( 'Skip the planner, get a straight answer from a person.', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>

...
?>
<!-- wp:group {"tagName":"aside","className":"ls-cta-inline-card ls-cta-inline","style":{"color":{"background":"var:custom|color|surface|on-dark-card","text":"var:custom|color|text|on-dark"},"border":{"top":{"color":"var:custom|color|text|brand-on-dark","style":"solid","width":"1px"},"right":{"color":"var:custom|color|text|brand-on-dark","style":"solid","width":"1px"},"bottom":{"color":"var:custom|color|text|brand-on-dark","style":"solid","width":"1px"},"left":{"color":"var:custom|color|text|brand-on-dark","style":"solid","width":"3px"},"radius":"var:preset|border-radius|200"},"spacing":{"blockGap":"var:preset|spacing|20","padding":{"top":"var:preset|spacing|30","right":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
<aside class="wp-block-group ls-cta-inline-card ls-cta-inline has-text-color has-background" style="border-top-color:var(--wp--custom--color--text--brand-on-dark);border-top-style:solid;border-top-width:1px;border-right-color:var(--wp--custom--color--text--brand-on-dark);border-right-style:solid;border-right-width:1px;border-bottom-color:var(--wp--custom--color--text--brand-on-dark);border-bottom-style:solid;border-bottom-width:1px;border-left-color:var(--wp--custom--color--text--brand-on-dark);border-left-style:solid;border-left-width:3px;border-radius:var(--wp--preset--border-radius--200);color:var(--wp--custom--color--text--on-dark);background-color:var(--wp--custom--color--surface--on-dark-card);padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
	...
	<div class="wp-block-group ls-cta-inline__content">
		...
		<div class="wp-block-group ls-cta-inline__badge">
			...
			<div class="wp-block-group ls-cta-inline__badge-icon has-background" style="border-radius:var(--wp--preset--border-radius--200);background-color:var(--wp--custom--color--icon--background);padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--10)">
				<!-- wp:html -->
		...
		<p class="has-text-color" style="color:var(--wp--custom--color--text--on-dark)"><?php echo esc_html__( 'We can help you work out the next sensible step — no pressure, just a practical conversation.', 'ls-theme' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->

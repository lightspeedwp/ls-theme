...
<div class="wp-block-group ls-cta-reassurance has-background has-border-color" style="border-color:color-mix(in srgb, var(--wp--custom--color--text--on-dark) 8%, transparent);border-width:1px;border-radius:var(--wp--preset--border-radius--300);background-color:var(--wp--custom--color--surface--on-dark-card);padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group ls-cta-reassurance__primary">
		...
		<div class="wp-block-group ls-cta-reassurance__content">
			<!-- wp:paragraph {"className":"ls-cta-reassurance__badge","style":{"color":{"text":"var(--wp--custom--color--text--brand-on-dark)"},"typography":{"textTransform":"uppercase","letterSpacing":"var:custom|typography|letter-spacing|widest"}},"fontSize":"100"} -->
			<p class="ls-cta-reassurance__badge has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--brand-on-dark);letter-spacing:var(--wp--custom--typography--letter-spacing--widest);text-transform:uppercase"><?php echo esc_html__( 'Free consultation', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<h2 class="wp-block-heading has-text-color has-500-font-size" style="color:var(--wp--custom--color--text--on-dark);font-weight:var(--wp--custom--typography--font-weight--bold)"><?php echo esc_html__( 'A quick call before you commit', 'ls-theme' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"color":{"text":"var(--wp--custom--color--text--on-dark-muted)"}}} -->
			<p class="has-text-color" style="color:var(--wp--custom--color--text--on-dark-muted)"><?php echo esc_html__( 'Use a free consultation to check fit, ask questions and understand what a sensible next step could look like.', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	...
	<div class="wp-block-group ls-cta-reassurance__list">
		...
		<div class="wp-block-group ls-cta-reassurance__item" style="border-bottom-color:color-mix(in srgb, var(--wp--custom--color--text--on-dark) 8%, transparent);border-bottom-style:solid;border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--10)">
			<!-- wp:group {"className":"ls-cta-reassurance__item-icon","style":{"color":{"background":"color-mix(in srgb, var(--wp--custom--color--text--brand-on-dark) 20%, transparent)"},"border":{"radius":"var:preset|border-radius|300"},"spacing":{"padding":{"top":"var:preset|spacing|5","right":"var:preset|spacing|5","bottom":"var:preset|spacing|5","left":"var:preset|spacing|5"}}},"layout":{"type":"flex","justifyContent":"center","verticalAlignment":"center","flexWrap":"nowrap"}} -->
			<div class="wp-block-group ls-cta-reassurance__item-icon has-background" style="border-radius:var(--wp--preset--border-radius--300);background-color:color-mix(in srgb, var(--wp--custom--color--text--brand-on-dark) 20%, transparent);padding-top:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5);padding-bottom:var(--wp--preset--spacing--5);padding-left:var(--wp--preset--spacing--5)">
				<!-- wp:html -->
					<span class="ls-icon ls-icon--check" aria-hidden="true" style="display:inline-flex;flex-shrink:0;width:13px;height:13px;color:var(--wp--custom--color--text--brand-on-dark)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="13" height="13" fill="currentColor"><path d="M229.66,77.66l-128,128a8,8,0,0,1-11.32,0l-56-56a8,8,0,0,1,11.32-11.32L96,188.69,218.34,66.34a8,8,0,0,1,11.32,11.32Z"></path></svg></span>
					<!-- /wp:html -->
			</div>
			<!-- /wp:group -->
			...
			<p class="has-text-color" style="color:var(--wp--custom--color--text--on-dark);font-weight:var(--wp--custom--typography--font-weight--bold)"><?php echo esc_html__( 'A focused, practical conversation', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group ls-cta-reassurance__item" style="border-bottom-color:color-mix(in srgb, var(--wp--custom--color--text--on-dark) 8%, transparent);border-bottom-style:solid;border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--10)">
			...
			<!-- wp:paragraph {"style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"},"typography":{"fontWeight":"var:custom|typography|font-weight|bold"}}} -->
			<p class="has-text-color" style="color:var(--wp--custom--color--text--on-dark);font-weight:var(--wp--custom--typography--font-weight--bold)"><?php echo esc_html__( 'No pressure to commit to anything', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group ls-cta-reassurance__item">
			...
			<!-- wp:paragraph {"style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"},"typography":{"fontWeight":"var:custom|typography|font-weight|bold"}}} -->
			<p class="has-text-color" style="color:var(--wp--custom--color--text--on-dark);font-weight:var(--wp--custom--typography--font-weight--bold)"><?php echo esc_html__( 'Clear next steps once we understand your project', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->

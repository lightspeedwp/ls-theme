...
<div class="wp-block-button ls-button-cta-gradient" style="min-height:var(--wp--custom--spacing--tap-target-min)"><a class="wp-block-button__link has-text-color has-background has-border-color has-200-font-size has-custom-font-size wp-element-button" href="<?php echo esc_url( home_url( '/free-consultation/' ) ); ?>" style="border-color:var(--wp--custom--color--border--card);border-style:solid;border-width:1px;border-radius:var(--wp--preset--border-radius--500);color:var(--wp--custom--color--button--fill--text);background:linear-gradient(135deg, var(--wp--custom--color--phase--create) 0%, var(--wp--custom--color--link--accent) 60%, var(--wp--custom--color--link--accent) 100%);padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--20);font-weight:var(--wp--custom--typography--font-weight--bold)"><?php echo esc_html__( 'Start a project →', 'ls-theme' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></header>

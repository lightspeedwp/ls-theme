...
<section class="wp-block-group alignfull ls-search-hero" style="border-bottom-color:var(--wp--custom--color--border--card);border-bottom-style:solid;border-bottom-width:1px;padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--30)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<!-- wp:paragraph {"align":"center","className":"ls-optical-trim","style":{"typography":{"textTransform":"uppercase","letterSpacing":"var:custom|typography|letter-spacing|widest","fontWeight":"var:custom|typography|font-weight|semibold","lineHeight":"1"},"color":{"text":"var(--wp--custom--color--text--brand)"}},"fontSize":"100"} -->
			<p class="has-text-align-center has-text-color has-100-font-size ls-optical-trim" style="color:var(--wp--custom--color--text--brand);font-weight:var(--wp--custom--typography--font-weight--semibold);letter-spacing:var(--wp--custom--typography--letter-spacing--widest);line-height:1;text-transform:uppercase"><?php echo esc_html__( 'Search', 'ls-theme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->

		<!-- wp:heading {"textAlign":"center","level":1,"className":"ls-optical-trim","style":{"typography":{"fontWeight":"var:custom|typography|font-weight|extrabold","lineHeight":"1"},"spacing":{"margin":{"top":"var:preset|spacing|100"}}},"fontSize":"800"} -->
		<h1 class="wp-block-heading has-text-align-center has-800-font-size ls-optical-trim" style="margin-top:var(--wp--preset--spacing--100);font-weight:var(--wp--custom--typography--font-weight--extrabold);line-height:1"><?php echo esc_html__( 'Search LightSpeed', 'ls-theme' ); ?></h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","style":{"color":{"text":"var(--wp--custom--color--text--muted)"},"spacing":{"margin":{"top":"var:preset|spacing|60"}}},"fontSize":"300"} -->
		<p class="has-text-align-center has-text-color has-300-font-size" style="color:var(--wp--custom--color--text--muted);margin-top:var(--wp--preset--spacing--60)"><?php echo esc_html__( 'Use search to find services, solutions, proof, FAQs and resource content more quickly.', 'ls-theme' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:group {"layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|70"}}}} -->

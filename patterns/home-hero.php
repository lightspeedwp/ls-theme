	...
	<div class="wp-block-group ls-home-hero-content">
		...
		<div class="wp-block-group ls-hero-badge-neon">
			...
			<div class="wp-block-group">
				...
				<p class="has-text-color has-200-font-size" style="color:var(--wp--custom--color--text--on-dark);font-weight:var(--wp--custom--typography--font-weight--semibold);letter-spacing:var(--wp--custom--typography--letter-spacing--widest);text-transform:uppercase"><?php echo esc_html__( 'WordPress engineering partner', 'ls-theme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-group ls-hero-prompt-row" style="margin-top:var(--wp--preset--spacing--60)">
			...
			<div class="wp-block-group ls-hero-prompt-send has-background" style="border-radius:var(--wp--preset--border-radius--200);background-color:var(--wp--custom--color--text--on-dark-accent);padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--10)">
				...
				<div class="wp-block-outermost-icon-block has-text-color"><div class="icon-container" aria-hidden="true" style="color:var(--wp--custom--color--text--on-light);width:17px;transform:rotate(0deg) scaleX(1) scaleY(1)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" aria-hidden="true" focusable="false"><path d="M221.66,133.66l-72,72a8,8,0,0,1-11.32-11.32L196.69,136H40a8,8,0,0,1,0-16H196.69L138.34,61.66a8,8,0,0,1,11.32-11.32l72,72A8,8,0,0,1,221.66,133.66Z"></path></svg></div></div>
				<!-- /wp:outermost/icon-block -->
			</div>
			<!-- /wp:group -->
		</div>

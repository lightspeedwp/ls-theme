	...
	<div class="wp-block-group ls-home-hero-content">
		...
		<div class="wp-block-group ls-hero-badge-neon">
			...
			<div class="wp-block-group">
				...
				<!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"var:custom|typography|letter-spacing|widest","fontWeight":"var:custom|typography|font-weight|semibold"},"color":{"text":"var(--wp--custom--color--text--on-dark)"}},"fontSize":"100"} -->
				<p class="has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--on-dark);font-weight:var(--wp--custom--typography--font-weight--semibold);letter-spacing:var(--wp--custom--typography--letter-spacing--widest);text-transform:uppercase"><?php echo esc_html__( 'WordPress engineering partner', 'ls-theme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<p class="has-text-align-center has-text-color has-200-font-size" style="color:var(--wp--custom--color--text--on-dark-muted);margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html__( 'Describe your project and our AI planner will help you frame the brief, identify the right approach, and find the best starting point, before you commit to anything.', 'ls-theme' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:group {"className":"ls-hero-prompt-row","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"},"blockGap":"12px"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
		<div class="wp-block-group ls-hero-prompt-row" style="margin-top:var(--wp--preset--spacing--20)">
			...
			<div class="wp-block-group ls-hero-prompt-send has-background" style="border-radius:var(--wp--preset--border-radius--200);background-color:var(--wp--custom--color--text--on-dark-accent);padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--10)">
				<!-- wp:outermost/icon-block {"iconName":"","className":"has-text-color","width":"17px","style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"}}} -->
				<div class="wp-block-outermost-icon-block has-text-color"><div class="icon-container" style="color:var(--wp--custom--color--text--on-dark);width:17px;transform:rotate(0deg) scaleX(1) scaleY(1)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor"><path d="M221.66,133.66l-72,72a8,8,0,0,1-11.32-11.32L196.69,136H40a8,8,0,0,1,0-16H196.69L138.34,61.66a8,8,0,0,1,11.32-11.32l72,72A8,8,0,0,1,221.66,133.66Z"></path></svg></div></div>
				<!-- /wp:outermost/icon-block -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-group ls-hero-pills" style="margin-top:var(--wp--preset--spacing--20)">
			<!-- wp:paragraph {"className":"ls-hero-pill","style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"}},"fontSize":"100"} -->
			<p class="ls-hero-pill has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--on-dark)"><?php echo esc_html__( 'Plan a WordPress website', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"className":"ls-hero-pill","style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"}},"fontSize":"100"} -->
			<p class="ls-hero-pill has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--on-dark)"><?php echo esc_html__( 'Scope a tour operator website', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"className":"ls-hero-pill","style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"}},"fontSize":"100"} -->
			<p class="ls-hero-pill has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--on-dark)"><?php echo esc_html__( 'Plan a publisher website', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"className":"ls-hero-pill","style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"}},"fontSize":"100"} -->
			<p class="ls-hero-pill has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--on-dark)"><?php echo esc_html__( 'Scope a WooCommerce store', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"className":"ls-hero-pill","style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"}},"fontSize":"100"} -->
			<p class="ls-hero-pill has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--on-dark)"><?php echo esc_html__( 'Plan an education or LMS website', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"className":"ls-hero-pill","style":{"color":{"text":"var(--wp--custom--color--text--on-dark)"}},"fontSize":"100"} -->
			<p class="ls-hero-pill has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--on-dark)"><?php echo esc_html__( 'Assess AI readiness for our website', 'ls-theme' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->

		<!-- wp:paragraph {"align":"center","style":{"color":{"text":"var(--wp--custom--color--text--on-dark-muted)"},"spacing":{"margin":{"top":"var:preset|spacing|20"}}},"fontSize":"100"} -->
		<p class="has-text-align-center has-text-color has-100-font-size" style="color:var(--wp--custom--color--text--on-dark-muted);margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html__( 'Prefer to speak directly?', 'ls-theme' ); ?> <a href="<?php echo esc_url( home_url( '/consultation/' ) ); ?>" style="color:var(--wp--custom--color--text--on-dark-accent)"><?php echo esc_html__( 'Book your consultation instead', 'ls-theme' ); ?></a></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</section>

...
<article class="wp-block-group is-style-stat-segment">
	...
	<!-- wp:paragraph {"style":{"typography":{"fontFamily":"var:preset|font-family|heading","fontWeight":"var:custom|typography|font-weight|extrabold"}},"fontSize":"800"} -->
	<p class="has-800-font-size" style="font-family:var(--wp--preset--font-family--heading);font-weight:var(--wp--custom--typography--font-weight--extrabold)"><?php echo esc_html__( '18k', 'ls-theme' ); ?><span style="color:var(--wp--custom--color--text--brand)"><?php echo esc_html__( '+', 'ls-theme' ); ?></span></p>
	<!-- /wp:paragraph -->

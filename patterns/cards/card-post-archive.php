...
<article class="wp-block-group is-style-card-post ls-card-post-archive"><!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"customOverlayColor":"#FFF","isUserOverlayColor":false,"contentPosition":"top left","isDark":false,"className":"ls-card-post__media ls-card-post-archive__media is-style-card-post-media","style":{"spacing":{"padding":{"top":"var:preset|spacing|10","right":"var:preset|spacing|10","bottom":"var:preset|spacing|10","left":"var:preset|spacing|10"}}},"layout":{"type":"constrained"}} -->
	...
	<!-- wp:group {"className":"ls-card-post__content ls-card-post-archive__content","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","flexWrap":"nowrap"}} -->
	<div class="wp-block-group ls-card-post__content ls-card-post-archive__content"><!-- wp:group {"className":"ls-card-post-archive__text","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","flexWrap":"nowrap"}} -->
		...
		<!-- wp:group {"className":"ls-card-post__meta ls-card-post-archive__meta","layout":{"type":"flex","flexWrap":"wrap","verticalAlignment":"center"}} -->
		<div class="wp-block-group ls-card-post__meta ls-card-post-archive__meta"><!-- wp:group {"className":"ls-card-post-archive__meta-item","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->

	...
	<div class="wp-block-group ls-home-hero-content">
		...
		<div class="wp-block-group ls-hero-badge-neon">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-outermost-icon-block has-text-color"><div class="icon-container" aria-hidden="true" style="color:var(--wp--custom--color--text--on-dark-accent);width:6px;transform:rotate(0deg) scaleX(1) scaleY(1)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="12"></circle></svg></div></div>
